<?php
    ...
    function getParams($input,$Boolean){   
        ...
        foreach($input as $param => $value){
            ...
            if ($Boolean){
                ...
                if ($param !== "CodeUser" and $param !== "IdResponse" and $param !== "Response" and $param !== "name"){
                    $filterParams[] = "$param = :$param";    
                }
    ...
    function bindAllValues($statement, $params,$Boolean){
        foreach($params as $param => $value){
            ...
            if ($param !== "Password" and $param !== "IdResponse" and $param !== "Response" and $param !== "name"){
                $statement->bindValue(":$param", $value);
            }
           }
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET'){
        $codu = $_GET['CodeUser']; // se obtiene el tipo de documento de identificación para la consulta
        $pass = $_GET['Password'];
        
        $model = new UserDao();
        $json = $model->getUserLogin($codu,$pass);
